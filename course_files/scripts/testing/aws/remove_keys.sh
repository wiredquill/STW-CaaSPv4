...
pause
scp -i "susetech-k8s-keypair.pem" susetech-k8s-keypair.pub ec2-user@ws.susetech.org:/home/ec2-user/.ssh/id_rsa.pub

pause
scp -i "susetech-k8s-keypair.pem" susetech-k8s-keypair.pem ec2-user@ws.susetech.org:/home/ec2-user/.ssh/id_rsa.pem
